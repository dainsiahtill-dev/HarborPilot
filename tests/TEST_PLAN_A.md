# HarborPilot Stage A Test Plan (Unit/Contract)

## Purpose
Stage A verifies HarborPilot's core logic, contracts, and safety rules at the unit/contract level without invoking external models or long‑running side effects.
