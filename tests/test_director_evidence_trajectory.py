...
def _load_module(rel_path: str, name: str):
    ...
    module_path = repo_root / "harborpilot" / rel_path
...
def _load_evidence():
    return _load_module("modules/harborpilot-loop/director_evidence.py", "director_evidence")


def _load_trajectory():
    return _load_module("modules/harborpilot-loop/director_trajectory.py", "director_trajectory")
