...
export function ContextMenu({ x, y, items, onClose, title }: ContextMenuProps) {
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-50 min-w-[180px] overflow-hidden rounded-lg border border-white/10 bg-black/90 p-1 shadow-[0_0_24px_rgba(0,0,0,0.5)] backdrop-blur-md animate-in fade-in zoom-in-95 duration-100"
      style={style}
