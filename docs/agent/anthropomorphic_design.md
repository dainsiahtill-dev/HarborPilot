...
This document outlines the integration of cognitive architecture concepts from _Generative Agents_ into HarborPilot, strictly adhering to engineering constraints like traceability, replayability, and append-only immutability.
