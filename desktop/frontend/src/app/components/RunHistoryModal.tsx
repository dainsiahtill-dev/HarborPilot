  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-5xl h-[80vh] bg-[#1e1e1e] border-gray-800 text-gray-200 flex flex-col p-0 gap-0">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-400">
                          ...
                          {selectedRun.duration && (
                            <span>Duration: <span className="text-gray-200">{selectedRun.duration.toFixed(1)}s</span></span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-800">
                        ...
                        <div className="text-sm text-gray-200 font-mono bg-black/20 p-2 rounded">
                          {selectedRun.task_id || 'N/A'}
                        </div>
                        {selectedRun.error_code && (
                          <div className="mt-3">
                            <div className="text-xs text-red-400 font-semibold mb-1">Error Code</div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-800">
                          <div className="text-xs text-gray-400 mb-1">Tool Rounds</div>
                          <div className="text-xl font-semibold text-gray-200">{selectedRun.tool_rounds ?? '-'}</div>
                        </div>
                        <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-800">
                          <div className="text-xs text-gray-400 mb-1">Lines Read</div>
      ...
      <LogsModal
        ...
        banner={`Viewing logs for historical run: ${selectedRun?.id}`}
      />
    </>
  );
}
