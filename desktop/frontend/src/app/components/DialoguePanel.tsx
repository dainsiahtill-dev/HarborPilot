            ...
            <div className="ml-2 flex items-center gap-1 rounded bg-gray-800 p-0.5">
              <button
                ...
                className={`px-2 py-0.5 text-[11px] rounded ${
                  viewMode === 'tasks' ? 'bg-blue-500/20 text-blue-300' : 'text-gray-400 hover:text-gray-200'
                }`}
              >
                任务视图
              </button>
              <button
                ...
                className={`px-2 py-0.5 text-[11px] rounded ${
                  viewMode === 'stream' ? 'bg-blue-500/20 text-blue-300' : 'text-gray-400 hover:text-gray-200'
                }`}
              >
                日志流
              </button>
